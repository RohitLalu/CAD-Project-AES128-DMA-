...
#
# Script generated by Vivado on Sun Jan 18 17:40:32 +0530 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : picorv32_axi.sh
...
#
# Usage        : picorv32_axi.sh
#                picorv32_axi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                picorv32_axi.sh [-rerun]
#                picorv32_axi.sh [-reset_run]
#                picorv32_axi.sh [-clean]
#                picorv32_axi.sh [-reset_log]
#                picorv32_axi.sh [-help]
#
...
# script info
echo -e "picorv32_axi.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./picorv32_axi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot picorv32_axi xil_defaultlib.picorv32_axi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim picorv32_axi -key {Behavioral:sim_1:Functional:picorv32_axi} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_1564.protoinst" -protoinst "protoinst_files/picosoc_aes128.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb picorv32_axi.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./picorv32_axi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: picorv32_axi.sh [-help]\n\
Usage: picorv32_axi.sh [-step]\n\
Usage: picorv32_axi.sh [-lib_map_path]\n\
Usage: picorv32_axi.sh [-rerun]\n\
Usage: picorv32_axi.sh [-reset_run]\n\
Usage: picorv32_axi.sh [-clean]\n\
Usage: picorv32_axi.sh [-reset_log]\n\
Usage: picorv32_axi.sh [-keep_index]\n\
Usage: picorv32_axi.sh [-noclean_files]\n\n\
